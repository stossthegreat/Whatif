...
export interface Cell {
  ...
  /// Judge Says: set for the duration of one vote→judge-picks sequence. The
  /// vote itself rides the normal 'same' round machinery; this field is how
  /// endRound knows to pause (not run finishRound) and ask this member to
  /// crown one instead, once the vote closes.
  judgeSaysId?: string;
}
