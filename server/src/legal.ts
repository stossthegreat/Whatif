...
These Terms are between you and Rivlr, not Apple. Apple has no obligation to furnish maintenance or support, and no warranty obligation beyond refunding any purchase price (currently zero). Apple is not responsible for claims relating to the app (product liability, legal compliance, consumer protection, IP). Apple and its subsidiaries are third-party beneficiaries of these Terms and may enforce them against you. You warrant you are not in an embargoed country or on any restricted-parties list, and you will comply with applicable third-party agreements (e.g. your data plan).
...
TO THE FULLEST EXTENT PERMITTED BY LAW, RIVLR AND ITS PERSONNEL SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, OR EXEMPLARY DAMAGES — INCLUDING LOST PROFITS, LOST DATA, LOSS OF GOODWILL, OR THE CONDUCT OF OTHER USERS OR THIRD PARTIES — ARISING FROM OR RELATING TO THE SERVICE, EVEN IF ADVISED OF THE POSSIBILITY. OUR TOTAL LIABILITY FOR ALL CLAIMS WILL NOT EXCEED THE GREATER OF THE AMOUNT YOU PAID US IN THE LAST 12 MONTHS (CURRENTLY ZERO) OR £50. Nothing here excludes liability that cannot lawfully be excluded (including for death or personal injury caused by negligence, or fraud).
...
• Your account and profile: handle, avatar colour and photo, age confirmation, bio, city/country, pronouns, languages, interests, preferences and vibes
• Your friendships and friend requests — both directions
• The messages you sent, and the photos and voice notes you uploaded
• Your encounter history, the ratings and personality votes you cast, and your stats, badges and titles
• Your blocks and your push notification token
• All data on your device (stats, badges, moment cards)

WHAT MAY REMAIN
• Report records may be retained up to 24 months for community safety (they identify reported behaviour — remember: rooms are never recorded, so there is no video or audio of you anywhere to delete)
• Messages and media already delivered to other people's devices may persist on their side, like a text you already sent
• Residual copies leave rolling database backups within 30 days
...
Email m2mb@info.com with the subject "Delete my account" and the handle you used. We delete within 30 days and confirm by reply. If you signed in with Apple you can also revoke Rivlr under Settings → Apple ID → Sign-In & Security → Sign in with Apple on your device.

Deletion is permanent. Friendships and messages cannot be recovered.`;
