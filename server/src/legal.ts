...
Refunds are handled by Apple or Google under their own policies, not by us; we cannot issue or refuse them, though we will help you contact them. Except where the law requires otherwise, part-used periods are not refunded. If your subscription lapses or is refunded, paid features switch off — 1-on-1 rooms and any filter you had set return to the free tier — and everything free about your account, including your friends and messages, is unaffected.
